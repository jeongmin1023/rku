...
from app.papers.normalizer import NormalizedPaperCandidate, normalize_riss_item


class RISSClient(PaperSourceAdapter):
    source_name = "riss"

    def search_by_professor(self, professor: Professor) -> list[NormalizedPaperCandidate]:
        payload = load_sample_json("sample_riss_response.json")
