...
from app.papers.normalizer import NormalizedPaperCandidate, normalize_dbpia_item


class DBpiaClient(PaperSourceAdapter):
    source_name = "dbpia"

    def search_by_professor(self, professor: Professor) -> list[NormalizedPaperCandidate]:
        payload = load_sample_json("sample_dbpia_response.json")
